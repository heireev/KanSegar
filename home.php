        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide slide">
            ...
            <div class="content">
              ...
              <h3>Ikan segar harga terjangkau</h3>
          ...
          <div class="swiper-slide slide">
            ...
            <div class="content">
              ...
              <h3>Produksi langsung dari nelayan</h3>
              <a href="shop.php" class="btn">Belanja</a>
            </div>
          </div>
          ...
          <div class="swiper-slide slide">
            ...
            <div class="content">
              ...
              <h3>Dapatkan berbagai macam 'Sea Food' di KanSegar.</h3>
              <a href="shop.php" class="btn">Belanja</a>
            </div>
          </div>
  ...
  <section class="category">
    ...
    <div class="swiper category-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <a href="category.php?category=tawar" class="swiper-slide slide">
          <iconify-icon icon="carbon:fish-multiple" width="35" height="35" style="color: black;"></iconify-icon>
          <h3>Ikan air tawar</h3>
        </a>

        <a href="category.php?category=payau" class="swiper-slide slide">
          <iconify-icon icon="carbon:fish-multiple" width="35" height="35" style="color: black;"></iconify-icon>
          <h3>Ikan air Payau</h3>
        </a>

        <a href="category.php?category=laut" class="swiper-slide slide">
          <iconify-icon icon="carbon:fish-multiple" width="35" height="35" style="color: black;"></iconify-icon>
          <h3>Ikan air Laut</h3>
        </a>
        ...
        <a href="#" class="swiper-slide slide">
          <iconify-icon icon="tabler:clock-hour-8" style="color: black;" width="35" height="35"></iconify-icon>
          <h3>Coming Soon</h3>
        </a>
